...
class AssessmentTables @Inject()(
  ...
  class Assessments(tag: Tag) extends Table[StoredAssessment](tag, "assessment")
    ...
    override def * : ProvenShape[StoredAssessment] =
      (id, code, title, startTime, duration, platform, assessmentType, storedBrief, invigilators, state, tabulaAssessmentId, moduleCode, departmentCode, created, version).mapTo[StoredAssessment]
  ...
  class AssessmentVersions(tag: Tag) extends Table[StoredAssessmentVersion](tag, "assessment_version")
    ...
    override def * : ProvenShape[StoredAssessmentVersion] =
      (id, code, title, startTime, duration, platform, assessmentType, storedBrief, invigilators, state, tabulaAssessmentId, moduleCode, departmentCode, created, version, operation, timestamp, auditUser).mapTo[StoredAssessmentVersion]
