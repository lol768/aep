...
export function calculateTimingInfo(data, now) {
  ...
  if (hasFinalised) {
    ...
    if (timeRemaining > 0) {
      ...
      // In practice I don't think we will ever print the "finalise your submission" version any more, because if
      // you submitted anything and the time ran out, it's considered finalised and would be handled at the very top
